            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class=" form-signin" action="<?= site_url('AdminPage/insert_user') ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phonenumbs" id="inputPhoneNumber" class="form-control mb-3" placeholder="Insert Mobile Number" required="" autofocus="">
                                </div>
                    ...
                    <a href="<?= site_url('AdminPage/userstable') ?>" class="text-danger float-right">
