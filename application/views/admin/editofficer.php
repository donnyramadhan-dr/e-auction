                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php foreach ($user as $datas) { ?>
                                <form class=" form-signin" action="<?= site_url('AdminPage/update_officer/' . $datas->id_petugas) ?>" method="POST">
                                    <div class="form-group">
                                        <h5 class="text-left">ID Officer</h5>
                                        <label for="inputid" class="sr-only">Id Officer</label>
                                        <input value="<?= $datas->id_petugas; ?>" type="text" name="ids" id="inputid" class="form-control mb-3" disabled>
                                    </div>
