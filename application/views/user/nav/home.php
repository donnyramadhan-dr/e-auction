        ...
        <a class="navbar-brand" href="index.php"><h1>E - Auction</h1></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo site_url('UserPage/signin')?>">Sign in</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo site_url('UserPage/register')?>">Register</a>
                    </li>
                </ul>
            </div>
        </div>
